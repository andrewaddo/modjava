...
public class ChatbotController {
    ...
    public Map<String, String> sendMessage(@RequestBody Map<String, String> request) {
        ...
        try {
            ...
            intentResponseJson = genAiClient.models.generateContent("gemini-flash-latest", intentPrompt, null).text();
            ...
            if ("product_inquiry".equals(intent) && productQuery != null && !productQuery.isEmpty()) {
                ...
                String aiResponse = genAiClient.models.generateContent("gemini-flash-latest", finalResponsePrompt, null).text();
                response.put("response", aiResponse);
            } else {
                // Step 4: General question, use GenAI directly
                String aiResponse = genAiClient.models.generateContent("gemini-flash-latest", userMessage, null).text();
                response.put("response", aiResponse);
            }
